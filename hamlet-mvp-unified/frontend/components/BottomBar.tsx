...
import { CompassIcon, HomeIcon, UserCircleIcon } from './icons/Icons';
...
const BottomBar: React.FC<BottomBarProps> = ({ 
    ...
    const navItems = [
        ...
        { label: texts.compass, icon: CompassIcon, tab: AppTab.Compass, enabled: true },
        { label: texts.myProfile, icon: UserCircleIcon, tab: AppTab.UserProfile, enabled: true },
    ];
